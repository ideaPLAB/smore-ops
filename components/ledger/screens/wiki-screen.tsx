...
const UPDATES: { date: string; text: ReactNode }[] = [
  { date: '2026-08-30', text: <Bullets items={[
    <>가챠 품목변경 동작 정정: 슬롯 품목을 바꾸면 남아있던 잔량은 <b>판매 처리</b>되어 매출로 잡히고 재고에서 빠집니다. (이전에는 매장 재고로 되돌아갔는데, 실제 판매로 잡히도록 바로잡았습니다)</>,
    <>가챠 슬롯 <b>회수 버튼 추가</b>: 슬롯 위치를 옮길 때 사용합니다. 남은 수량을 <b>일부 또는 전량</b> 입력해 매장 재고로 되돌립니다 (판매 아님). 되돌린 뒤 옮길 슬롯에서 &lsquo;보충&rsquo;으로 채우면 이동 완료. → 위치만 옮길 땐 &lsquo;품목변경&rsquo; 대신 꼭 &lsquo;회수&rsquo;를 쓰세요.</>,
    '가챠 판매추정 매출 누계 표시 정확화: 이전에는 최근 50건만 더해 과거 매출이 빠졌는데, 전체 기록을 합산하도록 수정했습니다.',
    '(내부 정산) 과거 품목변경으로 재고에 잘못 되돌아갔던 207개를 판매로 정정, 매출 1,151,500원 반영.',
  ]} /> },
